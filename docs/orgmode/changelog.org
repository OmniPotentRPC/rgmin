...
~euclideancomplexfactory~. Packed interleaved ~(re, im)~, length
~2 n~. Projection and transport are the identity; retraction is
~x + v~. Not the sphere and not ~ComplexCircle~. A 3N cluster
is rejected. Reserved tokens 7-10 stay unused.
