...
HiGHS (`Q = I`) onto a box, trust region, or equalities. The C ABI
carries that set: `xts_solver_set_box` (NULL side unbounded),
`xts_solver_set_highs_trust`, and `xts_solver_add_equality`.
